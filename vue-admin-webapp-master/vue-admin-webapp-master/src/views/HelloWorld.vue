...
DoctoreditVage:''
      ...
      this.$get("https://www.jileaf.top/wxapp/qb/" + this.form5.sdrid)
        .then((res) => {
          ...
          if (res.data.data !== null) {
            this.$message("已绑定" + res.data.data);
          } else {
            this.$message("未绑定学校");
          }
        })
  ...
  this.$post('http://www.jileaf.top:8080/hm/iotcard/'+this.form6.sdrid)
    ...
    change1(e) {
      ...
      this.$get(
          'https://www.jileaf.top/wxapp/amap/'+
          e 
      ).then((res) => {
        console.log(res);
    ...
    getpro() {
        this.$get(
        "https://www.jileaf.top/wxapp/amap/中国"
      )
      .then(respon => {
        console.log(respon);
        this.options1 = respon.districts[0].districts;
      })
      .catch(err=>{
         console.log(err)
