...
Page({
  ...
  selectedOk: function () {
    ...
    //})
    app.globalData.city=this.data.centerData.title
    app.globalData.cityname=this.data.centerData.city
    app.globalData.districtname=this.data.centerData.district
    app.globalData.local=this.data.centerData.longitude+','+this.data.centerData.latitude
    app.globalData.ad=String(this.data.centerData.ad) 
    wx.navigateBack({
      delta: 1
    })
